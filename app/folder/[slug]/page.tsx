...
export default async function FolderPage({ params }: { params: { slug: string } }) {
    ...
    try {
        ...
        // Kalau foldernya gak ada di database, lempar 404
        if (!folder) {
            notFound();
        }
        ...
        return (
            <main className="min-h-screen bg-washi pt-24 pb-20">
                <div className="max-w-5xl mx-auto px-6">
                    ...
                    <Link href="/" className="inline-flex items-center gap-2 text-sm font-medium text-sumi-muted hover:text-sumi transition-colors mb-8">
                    ...
                    >
                        <div className="flex-1 p-8 md:p-12 flex flex-col justify-center relative z-10">
                            ...
                            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight tracking-tight drop-shadow-sm mb-4" style={{ color: colorStyles.text }}>
                                {folder.name}
                            </h1>
